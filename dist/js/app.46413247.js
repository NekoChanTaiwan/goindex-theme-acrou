;(function(e) {
	function t(t) {
		for (
			var n, o, c = t[0], s = t[1], u = t[2], d = 0, l = [];
			d < c.length;
			d++
		)
			(o = c[d]),
	...
	function c(e) {
		return (
			...
			'.' +
			{
				'chunk-0609f824': 'b866354e',
				'chunk-2d0af48a': '6301fae1',
				'chunk-072ae9f4': 'e7f180fb',
				'chunk-075e2f32': '124572ec',
				'chunk-76819182': '3b310d4a',
				'chunk-93557524': '6bff36b6',
				'chunk-2d0b2ee4': '3fe21659',
				'chunk-2d0f0fbe': 'baf9656d',
				'chunk-37c92f0e': 'e4513477',
				'chunk-5033dd42': '7187a584',
				'chunk-5ec06972': '2a65c7c8',
				'chunk-74a0e63a': '0b9c09d0',
				'chunk-2d225416': 'a47924c7',
				'chunk-2d1e3ca3': '22187660',
				'chunk-40ad1794': 'eb771516',
			}[e] +
			'.js'
		)
	}
	...
	;(s.e = function(e) {
						...
						for (
							var n =
									...
									'.' +
									{
										...
										'chunk-76819182': '102b88fa',
										'chunk-93557524': 'ae6b5749',
										'chunk-2d0b2ee4': '31d6cfe0',
										'chunk-2d0f0fbe': '31d6cfe0',
										'chunk-37c92f0e': '4a507e1e',
										'chunk-5033dd42': 'ae6b5749',
										'chunk-5ec06972': '6b2181ec',
							...
							if ('stylesheet' === u.rel && (d === n || d === r)) return t()
						}
		...
		(s.p =
			'https://cdn.jsdelivr.net/gh/NekoChanTaiwan/goindex-theme-acrou@v2.0.8.neko.3/dist/'),
		(s.oe = function(e) {
		...
		var n = function() {
			...
			c = {
				...
				mounted: function() {
					...
					this.load(),
						Promise.all([
							a.e('chunk-74a0e63a').then(a.t.bind(null, '764d', 7)),
							a.e('chunk-2d0f0fbe').then(a.t.bind(null, '9f61', 7)),
						]).then(function(t) {
							var a = t[1].default
				...
				computed: Object(r['a'])(
					{},
					Object(i['mapState'])('acrou/aplayer', [
						'player',
						'audios',
						'openedAudios',
					]),
					{
						...
						options: function() {
							...
							return Object(r['a'])(
								{ autoplay: !1, loop: 'all', order: 'list', preload: 'auto' },
								e,
								{
						...
						show: function() {
							return (
								...
								(this.openedAudios && this.openedAudios.length > 0)
							)
						},
					}
				),
			...
			s = c,
			u = a('2877'),
			d = Object(u['a'])(s, n, o, !1, null, null, null)
		t['default'] = d.exports
	},
	'2e32': function(e) {
	...
	'56d7': function(e, t, a) {
		...
		var n = a('896a'),
			o = a.n(n),
			r = (a('e260'), a('e6cf'), a('cca6'), a('a79d'), a('8bbf')),
			i = a.n(r),
			c = function() {
				var e = this,
					t = e.$createElement,
			...
			l = {
				name: 'App',
				components: { Layout: d['default'] },
				data: function() {
					return {
						github: 'https://github.com/NekoChanTaiwan/goindex-theme-acrou',
					}
				},
					...
					checkVersion: function() {
						...
						;(e && t === e) ||
							this.$notify({
								...
								message: this.$t('checkVersion.tips').replace(
									'${url}',
									this.github
								),
								duration: 0,
			...
			_ = a.n(C),
			x = a('d40e'),
			A = { autoSetContainer: !1, appendToBody: !0 },
			j = function(e, t) {
				return new Promise(function(a, n) {
					...
					r.on('success', function(e) {
						...
						A.appendToBody && document.body.appendChild(o),
						o.click(),
						A.appendToBody && document.body.removeChild(o)
				})
			},
			P = {
				copy: j,
		...
		;(i.a.prototype.$notify = x['a']),
			i.a.component('markdown', function() {
				return Promise.all([a.e('chunk-2d0af48a'), a.e('chunk-075e2f32')]).then(
					a.bind(null, 'b6ba')
				)
			})
		a('0808'), a('e558')
		document.write(
			...
			(i.a.prototype.$cdnpath = T['a']),
			i.a.use(o.a),
			i.a.use(g.a, m['a']),
			i.a.use(E),
			i.a.use(N['a'], { loading: Object(T['a'])('images/airplane.gif') }),
			i.a.use(V.a),
			new i.a({
				router: y['a'],
				store: k['a'],
			...
			actions: {
				set: function(e, t) {
					var a = t.dbName,
						...
						u = t.user,
						d = void 0 !== u && u
					Object(r['c'])({ dbName: n, path: i, value: s, user: d })
				},
				get: function(e, t) {
					var a = t.dbName,
						n = void 0 === a ? 'database' : a,
				...
				database: function(e) {
					var t =
						...
						a = t.user,
						n = void 0 !== a && a
					return Object(r['a'])({ user: n, defaultValue: {} })
				},
				...
				databasePage: function(e) {
					var t =
							arguments.length > 1 && void 0 !== arguments[1]
								...
								: {},
						a = t.basis,
						o = void 0 === a ? 'fullPath' : a,
						i = t.user,
						c = void 0 !== i && i
					return Object(r['a'])({
						path: '$page.'.concat(n['a'].app.$route[o]),
						user: c,
						defaultValue: {},
					})
				},
				...
				pageSet: function(e, t) {
					...
					return Object(r['a'])({
						...
						defaultValue: Object(o['cloneDeep'])(a.$data),
					})
				},
				...
				pageClear: function(e, t) {
					var a = t.basis,
						...
						c = void 0 !== i && i
					return Object(r['a'])({
						path: '$page.'.concat(n['a'].app.$route[o], '.$data'),
						user: c,
						validator: function() {
							return !1
						},
	...
	'6c69': function(e, t, a) {
		...
		var n = function() {
					...
					[
						a('div', { staticClass: 'container' }, [
							a('div', { staticClass: 'navbar-brand' }, [
								a(
									'a',
									{ staticClass: 'navbar-item', attrs: { href: e.currgd.id } },
									[
										a('h3', { staticClass: 'title is-3 has-text-white' }, [
											e._v(e._s(e.siteName)),
										]),
									]
								),
								a(
									...
									{
										class:
											'navbar-burger burger ' + (e.isActive ? 'is-active' : ''),
										attrs: {
											role: 'button',
											'aria-label': 'menu',
											'aria-expanded': 'false',
									...
									a('div', { staticClass: 'navbar-start' }, [
										e.gds.length > 0 && e.getCurrGD.length > 0
											? a(
													...
													[
														a('a', { staticClass: 'navbar-link' }, [
															e._v(e._s(this.currgd.name)),
														]),
														a(
															'div',
								...
								e._l(e.$languages, function(t) {
									return a(
										'a',
										{
											...
											class:
												'navbar-item' +
												(e.currLanguage === t.value ? ' is-active' : ''),
											on: {
												click: function(a) {
			...
			i = [
				function() {
					var e = this,
						t = e.$createElement,
						a = e._self._c || t
					return a('a', { staticClass: 'navbar-link is-arrowless' }, [
						a('i', { staticClass: 'fa fa-language' }),
					])
				},
			],
			c = {
			...
			s = c,
			u = a('2877'),
			d = Object(u['a'])(s, r, i, !1, null, null, null),
			l = d.exports,
			f = function() {
				var e = this,
					t = e.$createElement,
				...
				return a(
					...
					[
						e._m(0),
						a('div', { staticClass: 'navbar-dropdown is-left' }, [
							a(
								'a',
								{ staticClass: 'navbar-item', on: { click: e.cleanCache } },
			...
			p = [
				...
				function() {
					var e = this,
						t = e.$createElement,
						a = e._self._c || t
					return a('span', { staticClass: 'icon' }, [
						a('i', {
			...
			k = a('f3f7'),
			O = {
				components: { headerLocales: l, headerSetting: w, ViewMode: k['a'] },
				created: function() {
					;(this.siteName = document.getElementsByTagName(
						'title'
					)[0].innerText),
						window.gds &&
							window.gds.length > 0 &&
			...
			C = O,
			_ = Object(u['a'])(C, n, o, !1, null, null, null)
		t['default'] = _.exports
	},
	'85b3': function(e, t) {
		e.exports = VueI18n
	...
	'88e9': function(e, t, a) {
		...
		var n = function() {
				...
				return a(
					...
					[
						a('Head'),
						a('section', { staticClass: 'section' }, [
							a(
								'div',
								{ staticClass: 'container' },
								[a('feb-alive', [a('router-view')], 1), a('Footer')],
								1
							),
						]),
						a('APlayer'),
			...
			u = s,
			d = a('2877'),
			l = Object(d['a'])(u, n, o, !1, null, null, null)
		t['default'] = l.exports
	},
	'8bbf': function(e, t) {
		e.exports = Vue
	...
	9225: function(e, t, a) {
		...
		o.a.use(i.a)
		var u = s()
		;(o.a.prototype.$languages = Object.keys(u).map(function(e) {
			return { label: u[e]._name, value: e }
		})),
			(t['a'] = new i.a({
				locale:
					c['a'].cookies.get('lang') ||
					window.gdconfig.themeOptions.languages ||
					'zh-chs',
				fallbackLocale: 'en',
				messages: u,
			}))
	...
	'95a2': function(e, t, a) {
		...
		function f(e) {
			var t = e.dbName,
				...
				c = e.user,
				s = void 0 !== c && c
			d.set(l({ dbName: a, path: o, user: s }), i).write()
		}
		function p(e) {
			var t = e.dbName,
				a = void 0 === t ? 'database' : t,
			...
			return new Promise(function(e) {
				e(
					Object(s['cloneDeep'])(
						d.get(l({ dbName: a, path: o, user: u, defaultValue: i })).value()
					)
				)
			})
		}
		function h() {
			...
			return new Promise(function(e) {
				e(
					d.get(
						l({ dbName: a, path: o, user: i, validator: s, defaultValue: f })
					)
				)
			})
		}
	...
	'9bd2': function(e, t, a) {
		...
		c.interceptors.request.use(
			function(e) {
				return (
					(e.cancelToken = new o.a.CancelToken(function(e) {
						r['a'].dispatch('acrou/cancelToken/push', e)
					})),
					e
				)
			},
	...
	'9dac': function(e, t, a) {
		var n = {
			...
			'./common/BreadCrumb': ['2db9', 'chunk-76819182'],
			'./common/BreadCrumb.vue': ['2db9', 'chunk-76819182'],
			'./common/Footer': ['a1c2'],
			...
			'./page/GoPdf': ['fe7f', 'chunk-5ec06972'],
			'./page/GoPdf.vue': ['fe7f', 'chunk-5ec06972'],
			'./page/GoText': ['c556', 'chunk-37c92f0e'],
			'./page/GoText.vue': ['c556', 'chunk-37c92f0e'],
			'./page/GoVideo': ['0262', 'chunk-0609f824'],
			'./page/GoVideo.vue': ['0262', 'chunk-0609f824'],
			'./page/GoView': ['e42c', 'chunk-76819182', 'chunk-2d225416'],
			'./page/GoView.vue': ['e42c', 'chunk-76819182', 'chunk-2d225416'],
			'./page/components/grid': ['2a7a', 'chunk-5033dd42'],
			'./page/components/grid/': ['2a7a', 'chunk-5033dd42'],
			'./page/components/grid/index': ['2a7a', 'chunk-5033dd42'],
			'./page/components/grid/index.vue': ['2a7a', 'chunk-5033dd42'],
	...
	a1c2: function(e, t, a) {
		...
		var n = function() {
			...
			i = r,
			c = a('2877'),
			s = Object(c['a'])(i, n, o, !1, null, null, null)
		t['default'] = s.exports
	},
	a363: function(e, t, a) {
		var n = {
			...
			r = {
				set: function() {
					var e =
						...
						n = { expires: 1 }
					Object.assign(n, a),
						o.a.set('go2index-'.concat('2.0.8', '-').concat(e), t, n)
				},
				get: function() {
					var e =
						arguments.length > 0 && void 0 !== arguments[0]
							? arguments[0]
							: 'default'
					return o.a.get('go2index-'.concat('2.0.8', '-').concat(e))
				},
				getAll: function() {
					return o.a.get()
				},
				remove: function() {
					var e =
						arguments.length > 0 && void 0 !== arguments[0]
							? arguments[0]
							: 'default'
					return o.a.remove('go2index-'.concat('2.0.8', '-').concat(e))
				},
			},
			i = r,
			c = a('95a2'),
				...
				open: function(e) {
					...
					t.setAttribute('href', e),
						...
						document.body.removeChild(
							document.getElementById('d2admin-link-temp')
						)
				},
			}
		t['a'] = s
			...
			actions: {
				...
				add: function(e, t) {
					...
					return new Promise(function(e) {
						...
						if (
							(t >= 0 &&
								(a.openedAudios.splice(t, 1),
								a.player.list.remove(t + a.customAudios.length || 0)),
							a.player.list.add(o),
							a.openedAudios.push(o),
							r)
						) {
						...
						n(
							'acrou/db/set',
							{ path: 'audio.list', value: a.openedAudios },
							{ root: !0 }
						),
							e()
					})
										...
										while (1)
											switch ((e.prev = e.next)) {
												...
												case 2:
													;(o = e.sent),
														(t.openedAudios = o),
														(t.audios = t.customAudios.concat(o)),
														n()
												case 6:
												case 'end':
													return e.stop()
		...
		var n = a('e5f2'),
			...
			i = function(e) {
				var t = e.title,
					...
					n = e.type,
					i = e.duration
				o()({ title: r['a'].t(t), message: r['a'].t(a), type: n, duration: i })
			}
		t['a'] = i
	},
	d6c0: function(e, t, a) {
	...
	e0a1: function(e, t, a) {
		...
		var n = function() {
			...
			i = {
				...
				methods: {},
				components: { Navbar: r['default'] },
			},
			c = i,
			s = a('2877'),
			u = Object(s['a'])(c, n, o, !1, null, null, null)
		t['default'] = u.exports
	},
	e36f: function(e, t, a) {
		a('d3b7'),
	...
	e862: function(e) {
		e.exports = JSON.parse(
			'{"_name":"繁體中文","languages":"選擇語言","index":"首頁","folder":"資料夾","notify":{"title":"提示"},"copy":{"text":"複製","success":"複製成功","error":"複製失敗"},"list":{"view":{"gridMode":"網格視圖","listMode":"列表視圖"},"auth":"目錄加密，請輸入密碼","title":{"file":"文件","moditime":"修改時間","size":"大小","operation":"操作"},"loading":"載入中...","opt":{"copy":"複製連結","newTab":"開啟至新分頁","download":"下載"},"total":"共","item":"項"},"search":{"placeholder":"搜尋..."},"page":{"video":{"play":"播放","download":"下載","link":"下載網址"},"text":{"loading":"載入中..."}},"setting":{"clear":{"text":"清理快取","success":"快取清理成功"}},"checkVersion":{"tips":"檢測到新版本，<a href=\'${url}\'>前往GitHub</a>"},"error":{"401":"未授權，請登錄","shortcut_not_down":"捷徑無法打開/下載"}}'
		)
	},
	edd4: function(e) {
		e.exports = JSON.parse(
			'{"_name":"English","languages":"Languages","index":"Home","folder":"Folder","notify":{"title":"Notify"},"copy":{"text":"Copy","success":"Copy successful","error":"Copy failed"},"list":{"view":{"gridMode":"Grid view","listMode":"List view"},"auth":"Directory encryption, please enter password","title":{"file":"File","moditime":"Modified Time","size":"Size","operation":"Actions"},"loading":"Loading...","opt":{"copy":"Copy link","newTab":"Open a new tab","download":"Download"},"total":"Total","item":"item"},"search":{"placeholder":"Search resources..."},"page":{"video":{"play":"Play","download":"Download","link":"Download link"},"text":{"loading":"Loading..."}},"setting":{"clear":{"text":"Clean cache","success":"Cache cleanup successful"}},"checkVersion":{"tips":"New version detected, <a href=\'${url}\'>Go to GitHub</a>"},"error":{"401":"Unauthorized, please login","shortcut_not_down":"Shortcut can\'t open/download"}}'
		)
	},
	f3f7: function(e, t, a) {
		'use strict'
				...
				return a(
					'span',
					{
						...
						attrs: {
							title:
								'list' === e.mode
									? e.$t('list.view.gridMode')
									: e.$t('list.view.listMode'),
						},
